...
setAnchorPeer() {
  ...
  local peerNum=$2
  local channelName=$3
  . scripts/setAnchorPeer.sh $orgName $peerNum $channelName
}
...
infoln "Joining is peers to the channel..."
joinChannel is 0
joinChannel is 1
infoln "Joining cs peers to the channel..."
joinChannel cs 0
joinChannel cs 1
joinChannel cs 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for is..."
setAnchorPeer is 0 $CHANNEL_NAME
infoln "Setting anchor peer for cs..."
setAnchorPeer cs 0 $CHANNEL_NAME
